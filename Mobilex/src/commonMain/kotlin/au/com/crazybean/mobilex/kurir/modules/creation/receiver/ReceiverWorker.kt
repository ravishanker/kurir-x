...
class ReceiverWorker(private val userData: UserData?,
                     private val repository: TasksRepository?) : Worker() {
    fun createTask(origin: Address, dest: Address, parcel: Parcel, receiver: Contact): Emitter<Boolean> {
