...
public class MelonAlert {
    ...
    public class Builder {
        ...
        public func setOptions(_ options: [String], style: UIAlertAction.Style = .default, handler: ((UIAlertAction) -> Void)? = nil) -> Builder {
        ...
        public func addTextField(_ handler: ((UITextField) -> Void)?) -> Builder {
            handlers.append(handler)
            return self
        }
        
        public func addAction(_ title: String?, handler: ((UIAlertAction) -> Void)? = nil) -> Builder {
            return addAction(title, style: .default, handler: handler)
        }
        
        public func addAction(_ title: String?, style: UIAlertAction.Style = .default, handler: ((UIAlertAction) -> Void)? = nil) -> Builder {
